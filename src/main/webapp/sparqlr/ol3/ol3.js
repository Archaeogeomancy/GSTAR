...
//PJC
// create a function to parse the json and create mappable bits:
var gstarJson = new ol.layer.Vector("Test JSON GSTAR", {
    projection: bng,
    protocol: new ol.protocol.HTTP({
        url: "http://localhost:8080/sparqlr/api/test/jsonld",
